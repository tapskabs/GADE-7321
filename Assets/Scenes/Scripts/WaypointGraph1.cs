...
public class WaypointGraph1 : MonoBehaviour
{
    ...
    public void BuildGraph()
    {
        ...
        AddEdge(waypointObjects[5], waypointObjects[6]);//(branch)
        AddEdge(waypointObjects[5], waypointObjects[7]);//(branch)
        AddEdge(waypointObjects[6], waypointObjects[8]);
        ...
        AddEdge(waypointObjects[10], waypointObjects[11]);
